    ...
    <section id="hero" className="min-h-screen pt-32 pb-16 px-4 md:px-12 flex flex-col justify-center relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10 grid lg:grid-cols-2 gap-12">
        <div className="animate-cyber-slide">
          <div className="inline-block bg-cyber-yellow text-black font-bold px-3 py-1 text-xs tracking-widest mb-6">
            WARNING: SYSTEM ACTIVE
          </div>

          <h1 className="text-6xl sm:text-7xl lg:text-8xl font-black mb-2 leading-none glitch" data-text="VASANTHA">
          ...
          <div className="border-l-4 border-cyber-magenta pl-6 my-8 py-2">
            ...
            <p className="text-[#aaa] text-sm md:text-base leading-relaxed max-w-md font-mono">
          ...
          <div className="flex flex-col sm:flex-row gap-6 mt-12">
             <a href="#projects" className="relative group inline-block font-mono font-bold tracking-widest text-sm text-center">
                ...
                <div className="absolute inset-0 border border-cyber-cyan text-cyber-cyan group-hover:text-black transition-colors clip-scifi" />
                <div className="relative px-8 py-4 uppercase text-cyber-cyan group-hover:text-black z-10 transition-colors">
                   Initialize_Projects
                </div>
             </a>
             ...
             <a href="#contact" className="relative group inline-block font-mono font-bold tracking-widest text-sm text-center">
                ...
                <div className="absolute inset-0 border border-cyber-magenta text-cyber-magenta group-hover:text-black transition-colors clip-scifi" />
                <div className="relative px-8 py-4 uppercase text-cyber-magenta group-hover:text-black z-10 transition-colors">
                   Comm_Link
                </div>
             </a>
          </div>
