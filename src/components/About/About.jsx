      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-4 relative group">
             ...
             <div className="relative aspect-square border border-[#333] clip-scifi bg-[#111] flex flex-col items-center justify-center p-8">
                 <div className="text-9xl font-black text-[#222]">VM</div>
          ...
          <div className="lg:col-span-8 flex flex-col gap-6">
             <CyberCard borderColor="cyber-yellow" title="PROFILE_SUMMARY">
               <h3 className="text-3xl font-bold text-white mb-6">Building digital <span className="text-cyber-yellow">products</span> and <span className="text-cyber-magenta">enterprise</span> systems.</h3>
               <div className="font-mono text-sm leading-relaxed text-[#bbb] space-y-4">
                 <p>
